...
import (
	...
	"github.com/adevinta/vulcan-core-cli/vulcan-core/gen/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "vulcan-persistence-cli",
		Short: `CLI client for the vulcan-persistence service`,
	}
	...
	c.UserAgent = "vulcan-persistence-cli/1.0"
